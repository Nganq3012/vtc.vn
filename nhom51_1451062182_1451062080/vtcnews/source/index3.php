...
<header>
        ...
        <div class="top-main">
            <div class="pull-left" style="display: inline-block; width: calc(100% - 300px);">
                <div class="breakcrumb">
                    <div class="pull-left">
                                                <a href="http://www.phapluatplus.vn/chinh-tri-xa-hoi/" class="letter">Chính trị - Xã hội</a>
                    </div>
                    <div class="pull-right">
                                                <ul class="list-child">
                                                    <li><a href="http://www.phapluatplus.vn/doi-song/">Đời sống</a><span>|</span></li>
                                                    <li><a href="http://www.phapluatplus.vn/giao-thong/">Giao thông</a><span>|</span></li>
                                                    <li><a href="http://www.phapluatplus.vn/thoi-luan/">Thời luận</a><span>|</span></li>
                                                </ul>
                                            </div>
    ...
    <form style="float: right;width: 182px;" action="/tim-kiem.html" method="get">
        <input name="q" type="text" style="border: 1px solid #bababa;padding: 0px 3px;outline: none;width: 150px;float: left;margin-top: 1px;font-size: 12px;height: 22px;" placeholder="Từ khóa ..."/>
        <button class="glyphicon glyphicon-search" style="background: #bababa;padding: 4px 9px;margin: 0;border: none;float: right;color: #FFF;"> </button>
    </form>
    ...
    <a class="tt" href="https://twitter.com/" rel="nofollow" target="_blank" title="Twitter">Twitter</a>
    <a class="yt" href="https://www.youtube.com/" rel="nofollow" target="_blank" title="Youtube">Youtube</a>
            ...
            <div class="col-fixed-300 pull-right">
                <style>
.bx-controls {text-align: center; margin-top: 5px;}
.bx-controls .bx-pager .bx-pager-item {display: inline-block;}
.bx-controls .bx-pager .bx-pager-item a {display: inline-block; margin: 0 4px; width: 11px; height: 11px; background: #EEE; border-radius: 11px; border: 1px solid #BABABA; text-indent: -9999px;}
.bx-controls .bx-pager .bx-pager-item a.active {background: #000; border: 1px solid #000; }
</style>
<p style="border: 1px solid #e2e2e3;border-bottom: none;color: #405f9d;border-top: 1px solid #405f9d;padding: 5px 9px 3px;font-size: 12px;text-transform: uppercase;margin: 0;"><a href="http://www.phapluatplus.vn/thuc-pham-sach/"><b>Thực phẩm sạch - Ẩm thực - Nhà hàng</b></a></p>



<div class="main-13" style="margin-top: 0; margin-bottom: 13px; padding: 8px;">
   <?php
      require "block3/thucphamsach.php"; 
      ?>
</div>
      ...
      ?>
                ...
                <div class="paging">
                                    ...
                                    <a class="" href="p7">7</a>
                                    <a class="" href="p8">8</a>
                                    <a class="" href="p1432">Cuối</a>
                                </div>
            </div>
            <div class="col-md-6">
                <div class="col-fixed-160 pul-left">
                    <div style="text-align:center;margin-top:0px;margin-bottom:0px;"><div style="width:160px;height:600px;"><script type="text/javascript" src="//media1.admicro.vn/ads_codes/ads_box_38751.ads"></script></div></div>    
                                    <div class="related-letter" style="margin-top: 23px;"><a href="http://www.phapluatplus.vn/multimedia-plus/">MULTIMEDIA PLUS</a></div>
